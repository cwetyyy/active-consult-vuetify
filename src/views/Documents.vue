<template>
  <div class="documents">
    <v-container class="my-5">
      <v-row>
        <v-col cols="8">
            <h2 v-if="$vuetify.breakpoint.mdAndUp" class="info--text">Monthly Documents</h2>
            <h4 v-if="$vuetify.breakpoint.smAndDown" class="info--text">Monthly Documents</h4>
        </v-col>
      ...
      <v-card>
          ...
          <v-card-text class="mt-4">
            <v-divider></v-divider>
              <v-row class="mt-4">
                  <v-col cols="12">
                      <v-autocomplete :items="getUsers" item-text="name" return-object v-model="document.client" placeholder="Select Client" color="info" outlined hide-details></v-autocomplete>
                  </v-col>
                  <v-col cols="12">
...
export default {
  ...
  methods: {
    ...
    submitDocument() {
      ...
      documentData.client_name = documentData.client.name
